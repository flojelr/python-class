...
![Alt text](2023-08-05-22-00-00.png)
...
flowchart LR
    A[Start] --> B{Is Nice?}
    A --> C{Is Naughty?}
    B -->|Yes| D[nice_count+1]
    C -->|Yes| E[naughty_count+1]
    D -->F{naughty_count > nice_count?}
    E -->F
    F -->|Yes| G[return Naughty]
    F -->|no| H[return Nice]
    G --> T[End]
    H --> T
```
